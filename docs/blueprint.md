...
> Transkripsi lengkap dari `archive/Blueprint.docx`. Dibuat supaya folder `archive/` tidak perlu dibuka lagi — semua isi blueprint ada di sini. Untuk daftar bagian mana yang **sudah diimplementasikan sesuai/berbeda** dari dokumen ini, lihat tabel deviasi di [`game-development-guide.md`](game-development-guide.md) §13.
