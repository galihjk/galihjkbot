...
| **Kursi Kosong Tahap 1** (`app/modules/games/implementations/kursi_kosong/`) | ✅ | 3-8 pemain, ronde 15 detik, kursi first-click-wins (belum contest window), validasi nomor ronde di callback DARI AWAL (beda dari `simple_game`), keyboard 2 kursi/baris dengan nama pemain yang sudah duduk, ter-update live tiap kali ada yang duduk. Didaftarkan tanpa syarat environment (game sungguhan) |
